...
public class SysDictTypeController {
    ...
    @PostMapping
    @Log(title = DICT_TYPE, businessType = BusinessType.INSERT)
    ...
    @PutMapping
    @Log(title = DICT_TYPE, businessType = BusinessType.UPDATE)
    ...
    @DeleteMapping("/{id}")
    @Log(title = DICT_TYPE, businessType = BusinessType.DELETE)
