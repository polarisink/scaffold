...
public class TimeUtil {
  ...
  public static final String S_F_STR_2 = "yyyy/MM/dd HH:mm:ss";
  ...
  public static final DateTimeFormatter CHINESE_DATE_PATTERN_FORMATTER = DateTimeFormatter.ofPattern(
      CHINESE_DATE_PATTERN);
  public static final DateTimeFormatter CHINESE_MINUTES_PATTERN_FORMATTER = DateTimeFormatter.ofPattern(
      CHINESE_MINUTES_PATTERN);
