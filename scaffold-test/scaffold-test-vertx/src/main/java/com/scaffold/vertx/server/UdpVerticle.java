...
public class UdpVerticle extends VerticleBase {
    ...
    @Override
    public Future<?> start() {
        DatagramSocketOptions options = new DatagramSocketOptions().setReuseAddress(true).setReusePort(true); // 必须开启，否则多实例部署会报错
        ...
        return socket.listen(8079, "0.0.0.0")
                ...
                .onSuccess(s -> {
                    ...
                    vertx.eventBus().consumer(UDP_MSG_EVENT, (Handler<Message<UdpMsgVo>>) event -> {
