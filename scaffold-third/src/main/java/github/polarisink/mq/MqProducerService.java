...
//   */
//  public void send(Archives a) {
//    rocketMQTemplate.convertAndSend(topic + ":tag1", a);
//    // 等价于上面一行
//    //rocketMQTemplate.send(topic + ":tag1", MessageBuilder.withPayload(a).build());
//  }
//
//  /**
...
//    LOG.info("[sendMsg]sendResult={}", JacksonUtil.to(sendResult));
//    return sendResult;
//  }
//
//  /**
...
//        LOG.info("Failed! cause:{}", throwable.getMessage());
//        // 处理消息发送异常逻辑
//      }
//    });
//  }
