package github.polarisink.scaffold.infrastructure.config.aysnc;
...
public class ThreadRejectedExecutionHandler implements RejectedExecutionHandler {
    ...
    /**
     * 饱和策略一：调用者线程执行策略 在该策略下，在调用者中执行被拒绝任务的run方法。除非线程池showdown，否则直接丢弃线程
     */
    ...
    /**
     * 饱和策略二：终止策略<br/> 在该策略下，丢弃被拒绝的任务，并抛出拒绝执行异常<br/>
     *
     * @see <a href="https://www.zhihu.com/question/64078605/answer/2501707188">TODO 研究一下为什么</a>
     */
    ...
    /**
     * 饱和策略三：丢弃策略 在该策略下，什么都不做直接丢弃被拒绝的任务
     */
    ...
    /**
     * 饱和策略四：弃老策略 在该策略下，丢弃最早放入阻塞队列中的线程，并尝试将拒绝任务加入阻塞队列
     */
