...
public class RestTemplateConfig {
    ...
    public RestTemplate restTemplate(ClientHttpRequestFactory httpRequestFactory) {
        ...
        messageConverters.stream().filter(converter -> converter instanceof StringHttpMessageConverter)
    ...
    public OkHttpClient okHttpConfigClient() {
        return new OkHttpClient().newBuilder().connectionPool(pool()).connectTimeout(connectTimeout, TimeUnit.SECONDS)
