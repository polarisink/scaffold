...
public class GenColumn {
    ...
    public Boolean getFormVisible() { return formVisible; }
    public void setFormVisible(Boolean formVisible) { this.formVisible = formVisible; }
    public String getFormWidget() { return formWidget; }
    public void setFormWidget(String formWidget) { this.formWidget = formWidget; }
