...
if not exist "%NATIVE_IMAGE%" (
    ...
    echo         %JAVA_HOME%
    echo Install GraalVM JDK 21 with Native Image support and update JAVA_HOME.
    exit /b 1
)
...
echo Building scaffold-biz Windows native executable...
echo JAVA_HOME=%JAVA_HOME%

pushd "%PROJECT_DIR%" || exit /b 1
call mvnw.cmd -Pnative -pl scaffold-biz -am -Dmaven.test.skip=true clean package
...
set "OUTPUT_FILE=%MODULE_DIR%\target\scaffold-biz.exe"
