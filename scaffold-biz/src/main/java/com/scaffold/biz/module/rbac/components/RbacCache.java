...
import static com.scaffold.core.base.constant.GlobalConstant.ROOT_PARENT_ID;
...
public class RbacCache {
    ...
    public List<SysMenu> userTree(Long userId) {
        ...
        List<SysMenu> tree = ITree.toTree(ROOT_PARENT_ID, menuSet, Comparator.comparing(SysMenu::getSortNo));
    ...
    public List<SysMenu> menuTree() {
        ...
        List<SysMenu> tree = ITree.toTree(ROOT_PARENT_ID, menuList, Comparator.comparing(SysMenu::getSortNo));
