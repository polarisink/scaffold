...
public class SysRoleController {
    ...
    public SysRoleWrapper roleWrapper(@PathVariable("id") Long id) {
     ...
     */
    @PostMapping
    @Log(title = ROLE, businessType = INSERT)
     ...
     */
    @PutMapping
    @Log(title = ROLE, businessType = UPDATE)
     ...
     */
    @DeleteMapping("/{id}")
    @Log(title = ROLE, businessType = DELETE)
